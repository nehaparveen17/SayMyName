...
switch (type.toLowerCase()) {
  ...
  private viewDetails = () => {
    ...
    this.httpClient.get('http://10.28.13.45:8081/getRecord/?studentID=' + parseInt(this.student_id)).subscribe((data: any) => {
  ...
  private deleteRecord = () => {
    this.ngxService.start();
    this.httpClient.delete('http://10.28.13.45:8081/deleterecord?student_id=' + parseInt(this.student_id)).subscribe(data => {
